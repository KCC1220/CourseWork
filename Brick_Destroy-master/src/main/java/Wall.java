...
public class Wall {
    ...
    private Brick[] makeTutorialLevel(Rectangle drawArea, int brickCnt, int lineCnt, double brickSizeRatio, int type){
        /*
          if brickCount is not divisible by line count,brickCount is adjusted to the biggest
          multiple of lineCount smaller then brickCount
         */
    ...
    private Brick[][] makeArcadeLevels(Rectangle drawArea, int brickCount,int lineCount,double brickDimensionRatio){
        Brick[][] tmp = new Brick[LEVELS_COUNT][];
        tmp[0] = makeTutorialLevel(drawArea,brickCount,lineCount,brickDimensionRatio,CLAY);
        tmp[1] = makeTutorialLevel(drawArea,brickCount,lineCount,brickDimensionRatio,CEMENT);
        tmp[2] = makeTutorialLevel(drawArea,brickCount,lineCount,brickDimensionRatio,STEEL);
        return tmp;
    }
