...
public class TutorialLevelController {
    ...
    main.java.model.TutorialLevelModel model = new main.java.model.TutorialLevelModel();
    ...
    public void mouseClicked(MouseEvent mouseEvent, TutorialLevelView gameBoard) {
        ...
        if (continueButtonRect.contains(p)) {
            ...
            model.restartLevel();
            main.java.controller.GameBoardController.resetTime();
            wall.ballReset();
            wall.wallReset();
            showPauseMenu = false;
            gameBoard.repaint();
            ...
            if (main.java.model.GameBoardModel.audio == 1) {
                audio=0;
                try {
            ...
            }else if(main.java.model.GameBoardModel.audio==0) {
