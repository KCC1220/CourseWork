...
public class CementBrick extends main.java.bricks.Brick {
    ...
    private final main.java.bricks.Crack crack;
    ...
    public CementBrick(Point point, Dimension size){
        ...
        crack = new main.java.bricks.Crack(DEF_CRACK_DEPTH,DEF_STEPS);
